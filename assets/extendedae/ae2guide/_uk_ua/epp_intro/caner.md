...
Усталено він наповнює лише рідини, але зі встановленням доповнень він буде здатний наповнювати й інші речовини.

### Підтримувані доповнення:
...
Підзарядка планшета енергії (з доповненням Applied Flux):
