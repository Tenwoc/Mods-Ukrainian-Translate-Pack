...
Основний складник для створення більшості предметів та машин ExtendedAE. Вам потрібно використовувати <ItemLink id="extendedae:entro_seed" />, щоб перетворити <ItemLink id="ae2:fluix_block" /> на [ентроїзований родючий флюїкс](./entro_budding.md), та зібрати його друзи, щоб отримати ентропійні кристали.
