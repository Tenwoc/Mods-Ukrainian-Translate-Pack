...
МЕ FE комірка – це основний метод зберігання енергії в Applied Flux. Їхня місткість базується на байтах, як і у [предметних/рідинних комірках](ae2:items-blocks-machines/storage_cells.md).

# Місткість комірок

Кожен байт усталено вміщує 1 048 576 FE (2^20), це можна змінити в конфігурації Appflux.

| Комірка                                | місткість FE комірки (усталена) |
| -------------------------------------- | ------------------------------: |
