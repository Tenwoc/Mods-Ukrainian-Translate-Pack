...
Однак, <ItemLink id="appflux:induction_card"/> може бути вставлена у портативну FE комірку, що дасть їй змогу автоматично заряджати усі предмети у вашому інвентарі.
