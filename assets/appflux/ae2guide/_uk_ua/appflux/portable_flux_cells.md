...
Портативні FE комірки мають лише чверть розміру звичайних [FE комірок](./flux_cells.md).

Однак, <ItemLink id="appflux:induction_card"/> може бути вставлена у портативну FE комірку, що дасть змогу їй автоматично заряджати усі предмети у вашому інвентарі.
