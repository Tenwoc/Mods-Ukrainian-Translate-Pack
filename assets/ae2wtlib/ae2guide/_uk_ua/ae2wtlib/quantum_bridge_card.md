...
Він дає змогу [бездротовим терміналам](wireless_terminals.md) створювати зв’язок із мережею через [квантовий міст](ae2:items-blocks-machines/quantum_bridge.md).
