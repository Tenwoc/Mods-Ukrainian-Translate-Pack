...
Цей блок дає вам змогу розширити вашу мережу на будь-яку відстань без кабелів, але не за межі виміру. Комунікатори можуть передавати до 32 каналів. Чим далі ви розміщуєте їх один від одного, тим вище їхнє енергоспоживання.
