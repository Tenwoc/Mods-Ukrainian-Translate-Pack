...
Оскільки основна передумова доповнення розглянута, ми тепер завершуємо деякими меншими додатковими функціями та доповненнями, наданими MEGA, як для повноти, так і для трохи більшої експериментальності.
...
Дещо нетиповий для решти доповнення, **Портативний верстак для комірок** доповнює звичайний <ItemLink id="ae2:cell_workbench" /> як його... менша версія. Насправді достатньо маленький, щоб поміститися на долоні, але водночас здатний налаштувати будь-яку комірку зберігання як нормальний.
