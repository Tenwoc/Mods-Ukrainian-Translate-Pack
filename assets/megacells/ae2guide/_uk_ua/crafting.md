...
Як додатковий бонус, MEGA також надає власний еквівалент на <ItemLink id="ae2:crafting_accelerator" />, хоча з перевагою забезпечення не одного, а _ЧОТИРЬОХ_ потоків співпроцесорної обробки в просторі кожного доданого блоку співпроцесора.
...
Доповнюючи <ItemLink id="ae2:pattern_provider" />, **МЕГА Постачальник шаблонів** підтримує тенденцію надання більших варіантів відповідних пристроїв AE2, подвоюючи місткість шаблонів, що дає змогу зберігати та обробляти загалом 18 шаблонів. Однак це також пов’язано з компромісною можливістю зберігати лише [**шаблони обробки**](ae2:items-blocks-machines/patterns.md), тому <ItemLink id="ae2:molecular_assembler" /> не зможе напряму працювати з ним.
