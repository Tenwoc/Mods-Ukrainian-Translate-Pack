...
Він дає змогу зберігати матерію з реплікаційної мережі у МЕ мережі, а також передавати її назад для виконання задач реплікації.
...
Предмети, зацифровані у реплікаційних чипах, будуть відображатися як шаблони вироблення у МЕ мережі.
