...
МЕ Покращений постачальник шаблонів – це ще один <ItemLink id="ae2:pattern_provider" />, який є ще кращою версію постачальника, ніж <ItemLink id="extendedae:ex_pattern_provider" />, надаючи можливість налаштувати грань, на яку буде переміщено будь-який окремий складник у шаблоні. Це потужне доповнення дає змогу автоматизувати машини, які потребують певних сторін для виконання певних вхідних складників, використовуючи єдиний блок без додаткових труб!

_Все заради тебе, Mekanism._
