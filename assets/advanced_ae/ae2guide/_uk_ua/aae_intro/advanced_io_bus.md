...
Розширена шина імпорту/експорту експортуватиме ресурси відповідно до свого фільтра, до фіксованої кількості, і на цьому зупиниться. У лівій частині інтерфейсу також є конфігурація, яка дає змогу користувачеві регулювати кількість предметів у запасі.
