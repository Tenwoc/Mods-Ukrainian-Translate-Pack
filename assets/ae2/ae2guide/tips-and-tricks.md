...
*Примітка: у деяких місцях предмети із посиланням не мають відмінювання, тому що ItemLink повертає тільки фактичну назву предмета без можливості редагувати її. Я намагався виправляти та обходити це наскільки можливо.*