...
- <ItemLink id="io_port" /> (1) можна налаштувати на «передачу до мережі» або «передачу до комірки сховища» за допомогою кнопки зі стрілкою посередині інтерфейсу. Він має 3 слоти для карток прискорення для досягнення максимальної швидкости.
