...
Однак, AE2 надає способи розміщувати та руйнувати блоки, тому також можливий варіант, де ваша ферма *замінює родючий кварц*. (Доведеться навчити систему періодично вставляти <ItemLink id="flawed_budding_quartz" /> у ферму та витягувати <ItemLink id="quartz_block" /> з окремого буфера для родючого кварцу)

Як повністю автоматизувати це, дивіться у розділі [Вдосконаленої ферми істинного кварцу](advanced-certus-farm.md).

Ця ферма трохи складніша, ніж [проста ферма істинного кварцу](simple-certus-farm.md), оскільки насправді це 3 окремі переплетені разом установки.
