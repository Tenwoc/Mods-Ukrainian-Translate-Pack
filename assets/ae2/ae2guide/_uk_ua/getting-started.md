...
Штампувальний прес приймає складники з різних сторін, подібно до печі. Введення зверху та знизу розмістить предмети у верхньому та нижньому слотах відповідно, а введення з боків помістить предмет у центральний слот. Результат вироблення можна так само виводити з боків.
...
Матеріальна енергія є основним компонентом Applied Energistics 2, ніби божевільний вчений створив багатоблокову скриню,
...
складати та забирати предмети — так само як класична <ItemLink id="minecraft:chest" />, із тим винятком,
...
<ItemLink id="export_bus" /> дає змогу експортувати предмети з мережі в приєднаний
...
<ItemLink id="controller" /> до своєї мережі. Це дасть вам змогу значно розширити свою мережу.
[Розумні кабелі](items-blocks-machines/cables.md) дають вам змогу бачити, як канали проходять через вашу мережу. Використовуйте їх широко на початку, щоб дізнатися, як працюють канали, або якщо у вас багато зайвого редстоуну та світлокаменю.
