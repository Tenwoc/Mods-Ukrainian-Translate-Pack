...
- Масове сховище, для всіх речей, яких у вас є більше кількох тисяч, таких як кругляк або залізо. Тут використовуються великі комірки, такі як 256К або комірки з доповнення MEGA.
...
<GameScene zoom="3" interactive={true}>
  <ImportStructure src="../assets/assemblies/network_storage_types.snbt" />
    ...
    <BoxAnnotation color="#dd3333" min="14 1 10" max="15 2.3 11" thickness="0.05">
        Локальне сховище на мобофермі. Ця конфігурація інтерфейсу шини зберігання дає змогу основній мережі отримувати доступ до сховища цієї підмережі. Шині зберігання надається високий пріоритет і вона відфільтрована на ресурси, що зберігаються в комірках підмережі.
