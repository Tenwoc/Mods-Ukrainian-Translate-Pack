...
2. <ItemLink id="storage_bus" /> зберігає блоки істинного кварцу в <ItemLink id="interface" />, даючи змогу [автоматизованій трансформації у воді](throw-in-water-automation.md) використати його для нового <ItemLink id="flawed_budding_quartz" />.
