...
**Зверніть увагу, що зазвичай вам не потрібно цього робити, оскільки заміни рідини в [терміналі кодування шаблонів](../items-blocks-machines/terminals.md#термінал-кодування-шаблонів) дають змогу використовувати саму рідину в рецепті майстрування замість відра.**
