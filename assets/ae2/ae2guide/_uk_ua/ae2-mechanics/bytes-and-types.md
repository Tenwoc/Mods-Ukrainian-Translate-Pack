...
[Комірки зберігання](../items-blocks-machines/storage_cells.md) визначаються як _байтами_, так і _типами_. Байти, як і у вашому комп’ютері, є мірою загальної кількості «речей» у сховищі. Типи є мірою того, скільки різних, так би мовити, _типів_ речей зберігається у сховищі. Кожен тип представляє унікальний предмет, тому 4096 кругляків — це 1 тип, а 16 різних мечів з різними зачаруваннями — це 16 типів.
