...
і працювати, як якийсь _плебей_, ви можете попросити свою систему ME зробити це за вас. Або автоматично виробляти предмети і експортувати їх кудись.
...
- <ItemLink id="processing_pattern" /> — це те, звідки береться велика гнучкість в автовироблення. Ці шаблони є найбільш узагальненим типом,
  ...
  використанні і не зважають на те, що відбувається між переміщенням складників і отриманням результату, ви можете робити дійсно цікаві речі,
  ...
  шаблоні. Насправді йому навіть байдуже, чи пов'язані складники якимось чином з результатом. Ви можете вказати йому «1 вишнева дошка = 1 зірка Незеру»
