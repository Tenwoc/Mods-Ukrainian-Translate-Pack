...
- <ItemLink id="pattern_provider" /> буде передавати тільки повні партії складників і тільки через одну сторону. Це корисно для того, щоб машини не отримували часткові партії, але іноді буває потрібно, щоб складники потрапляли в кілька місць.
...
_Примітка 2: ~~Тепер ваш GuideMe буде показувати гайди по всім перекладеним довідникам, які наявні у цьому пакеті.~~ GuideMe не буде показувати переклади аддонів ae2, які ви не встановлювали._

_Примітка 3: Виправлення з другої примітки трохи ламає гайдбук для старіших версій (1.20.х та нижче)._
