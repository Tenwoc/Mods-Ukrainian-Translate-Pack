...
Шина, яка функціонує як <ItemLink id="fluix_glass_cable" /> чи інші кабелі, але дає змогу перемикати стан її з’єднання редстоуновим сигналом. Це дає змогу відрізати ділянки [МЕ мережі](../ae2-mechanics/me-network-connections.md).
