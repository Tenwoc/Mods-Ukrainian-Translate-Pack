...
Картки-модифікатори змінюють поведінку AE2 [пристроїв](../ae2-mechanics/devices.md) та машин, збільшуючи їхню швидкість, покращуючи їхню фільтрувальну здатність, даючи змогу контролюватися редстоуном тощо.
...
Картки знищення переповнення можна застосовувати до [комірок зберігання](storage_cells.md) через <ItemLink id="cell_workbench" />, що дасть змогу видаляти вхідні речі, якщо комірка заповнена. (обов'язково [розгалужуйте](cell_workbench.md) свої комірки!) У поєднанні з карткою рівного розподілу, предмети будуть знищені, якщо секція цього конкретного предмета в комірці заповнена, навіть якщо секції інших предметів порожні.
...
Картки нечіткості дають змогу пристроям та інструментам з фільтрами фільтрувати за рівнем пошкодження та/або ігнорувати будь-які NBT предметів, що дає змогу, наприклад, експортувати всі залізні сокири незалежно від рівня пошкодження та чарів, або експортувати лише пошкоджені діамантові мечі, а не повністю цілі.
...
Картки вироблення дають змогу пристрою надсилати запити на вироблення до вашої системи [автовироблення](../ae2-mechanics/autocrafting.md), щоб отримати потрібні предмети.
