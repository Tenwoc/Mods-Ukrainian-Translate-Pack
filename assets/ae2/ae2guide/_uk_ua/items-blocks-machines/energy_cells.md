...
- <ItemLink id="dense_energy_cell" /> може зберігати 1,6 млн AE і призначена для випадків, коли ви хочете запускати мережу від накопиченої енергії або обробляти величезне миттєве споживання енергії великими уставами [просторового зберігання](../ae2-mechanics/spatial-io.md).
