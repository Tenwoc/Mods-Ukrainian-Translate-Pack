...
- <ItemLink id="fuzzy_card" /> дає змогу випромінювачу фільтрувати за рівнем пошкодження та/або ігнорувати будь-які NBT предметів
