...
Порт зберігання дає змогу швидко заповнювати або спорожняти [комірки сховища](../items-blocks-machines/storage_cells.md) до або з [мережевого сховища](../ae2-mechanics/import-export-storage.md).
...
- <ItemLink id="redstone_card" /> додає керування редстоуном, що дає змогу працювати за високим та низьким сигналами або одноразово за імпульс
