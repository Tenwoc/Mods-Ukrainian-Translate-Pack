...
Верстак для комірок дає змогу налаштовувати [комірки сховища](storage_cells.md) та <ItemLink id="view_cell" />.
...
- Робочий стіл можна налаштувати так, щоб він зберігав налаштування розгалуження після видалення комірки, що дає змогу копіювати налаштування між комірками.
