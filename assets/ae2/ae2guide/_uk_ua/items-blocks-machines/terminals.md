...
Ваш базовий термінал, що дає вам змогу переглядати та отримувати доступ до вмісту вашого [мережевого сховища](../ae2-mechanics/import-export-storage.md) та запитувати речі з вашої устави [автовироблення](../ae2-mechanics/autocrafting.md).
...
У верхньому правому куті центральної частини (кнопка молотка) відображається інтерфейс стану [автовироблення](../ae2-mechanics/autocrafting.md), що дає змогу бачити прогрес ваших автовироблень та що робить кожен [процесор вироблення](crafting_cpu_multiblock.md).
...
- У режимі майстрування:
  ...
  - Заміна рідин дає змогу використовувати збережені рідини замість відер рідин.
