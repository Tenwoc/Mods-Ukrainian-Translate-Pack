...
Шина експорту бере предмети та рідини (і все інше, за наявності доповнень) з [мережевого сховища](../ae2-mechanics/import-export-storage.md) та вводить їх у містило, якого вона торкається.
...
- <ItemLink id="crafting_card" /> дає змогу шині відправляти виробничі запити до вашої системи [автовироблення](../ae2-mechanics/autocrafting.md) для отримання речей у фільтрі. Можна встановити на витягання зі сховища та автовироблення, або тільки автовироблення.
