...
Для оптимізації, якщо шина експорту нещодавно нічого не експортувала, вона переходить у своєрідний «режим сну», де працює повільно, а прокидається та розганяється до повної швидкости (4 операції за секунду), коли успішно експортує щось.
