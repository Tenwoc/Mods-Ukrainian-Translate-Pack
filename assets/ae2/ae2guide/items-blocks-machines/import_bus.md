...
Для оптимізації, якщо шина імпорту нещодавно нічого не імпортувала, вона переходить у своєрідний «режим сну», де працює повільно, а прокидається та розганяється до повної швидкости (4 операції за секунду), коли успішно імпортує щось.
